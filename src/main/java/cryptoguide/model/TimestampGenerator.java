...
public class TimestampGenerator {
    ...
    TimestampGenerator() throws IllegalStateException {
    ...
    public static long convertToTimeStamp(String input) {
        ...
        if((inputLength == 8 || inputLength == 7) && input.charAt(5) == 'W') {
            ...
            int week = Integer.parseInt(input.substring(6,inputLength));
            ...
            int year = Integer.parseInt(input.substring(0,4));
            int week = Integer.parseInt(input.substring(6,inputLength - 3));
            ...
            input = date.toString();
        } else if(inputLength == 10 && input.endsWith("XX")) {
